...
include 'opendbDSP.php';
	...
	echo'<table class="TFtable">';
			...
			if($count>0)
			{
				...
				<td id="middle" valign="top">Summary of topic</td><td id="least" valign="top">Topic: <a href='.$pdf.' target="_blank">'.$bestlecture.'.pdf</a>';
			}
			else
			{
				echo'<tr><td valign="top"></td><td id="middle" align="center">No lecture pdf copy currently</td><td id="least"></td></tr>';
				}
