		...
		{	
			...
			while($record=mysql_fetch_assoc($result))
			{
				...
				if($type[1]=="keyword")
				{
					...
					echo'<tr><td valign="top"><img src="'.$thumbnail.'.jpeg" border=1><br>News Story: <a class="inline" onclick="loadVideo(\''.$videoName.'\');" href="#container"><img src="movieicon.jpg" border=1></td>
