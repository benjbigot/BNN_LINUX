...
def ffmpeg2(a):
		...
		p='vlc -I dummy --no-sout-video --sout-audio --no-sout-rtp-sap --no-sout-standard-sap --ttl=1 --sout-keep --sout "#transcode{acodec=s16l,channels=1,samplerate=16000}:std{access=file,mux=wav,dst=output.wav}" "'+a+'.mp4" vlc://quit'
